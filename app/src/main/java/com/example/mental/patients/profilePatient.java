package com.example.mental.patients;
...
import com.example.mental.api.profileAPI;
import com.example.mental.api.profilePatientAPI;
                    ...
                    if (response.body() != null) {
                        ...
                        try {
                            ...
                            if(message.equals("Success!")) {
                                ...
                                SharedPreferences prefChat = getContext().getSharedPreferences("Chat", Context.MODE_PRIVATE);
                                SharedPreferences.Editor edit = prefChat.edit();
                                edit.putString("username", profile.getString("email"));
                                edit.putString("avatar", pref.getString("special", null));
                                edit.putString("name", profile.getString("name").split(",")[0]);
                                edit.putString("image", "http://192.168.0.22/mentalImgs/" + profile.getString("image"));
                                edit.commit();
